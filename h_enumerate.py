...
def main():
    ...
    parser.add_argument("dir_idx", help="Index to directory of .tex files")
    ...
    parser.add_argument("--idx_to_month_path", default="./idx_to_month.yml", help="Path to yaml w/ index to month mapping")
    parser.add_argument("K", help="K splits of singular articles")

    args = parser.parse_args()
    dir_idx = int(args.dir_idx)
    with open(args.idx_to_month_path, 'r') as fh:
        subfolder_list = yaml.load(fh)
    directory = subfolder_list[dir_idx]
    parent = args.parent
    ...
    separate_articles(eqs, doc_list, './sep_{}'.format(directory), K)
